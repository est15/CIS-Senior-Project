    ...
    if (isset($_SESSION['username'])) {
        ...
        if(isset($_POST['vehicle'])){
            ...
            try {
                ...
                $stmt = mysqli_prepare($db,"SELECT * FROM mileage_master.mileages WHERE VIN = ?");

                // Bind the VIN Parameter
...
<html>
    ...
    <body style="background: rgb(235, 231, 231);">
        ...
        <div class="main" style="text-align: center;">
            ...
            <div>
                <!-- JavaScript to Control VINs Entered -->
                <script type="text/javascript">
                    function validateInput(){
                        ...
                        // If VIN passes then proceed                
                        return true;
                    }
                </script>

                <!-- Form for Adding VIN -->
                <form class="p-3 mt-3" onsubmit="return validateInput()" action="Search.php" method="post">
